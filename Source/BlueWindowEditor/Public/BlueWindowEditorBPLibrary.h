...
#include "BlueWindowEditorBPLibrary.generated.h"
...
*/
UCLASS()
class BLUEWINDOWEDITOR_API UBlueWindowEditorBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static bool GetActiveEditorViewportChanged();
};
